...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", userName=" + userName + ", password=" + password + ", email=" + email
				...
				+ lastLoginDate + ", getUserId()=" + getUserId() + ", getUserName()=" + getUserName() + ", getPassword()="
				+ getPassword() + ", getEmail()=" + getEmail() + ", getAddress()=" + getAddress() + ", getRole()="
				+ getRole() + ", getCreatedDate()=" + getCreatedDate() + ", getLastLoginDate()=" + getLastLoginDate()
